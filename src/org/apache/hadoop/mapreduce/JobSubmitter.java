...
class JobSubmitter {
  ...
  throws ClassNotFoundException, InterruptedException, IOException {
      return submitJobInternal(job,cluster,TokenCache.getTokenStorage());
  }
 ...
 * @param tokenStorage 
   ...
   */
  @SuppressWarnings("unchecked")
  JobStatus submitJobInternal(Job job, Cluster cluster, TokenStorage tokenStorage) 
  throws ClassNotFoundException, InterruptedException, IOException {
    ...
    try {
      ...
      TokenCache.obtainTokensForNamenodes(tokenStorage, new Path [] {submitJobDir}, conf);
      ...
      //
      populateTokenCache(conf,tokenStorage);
  ...
  @SuppressWarnings("unchecked")
  private void populateTokenCache(Configuration conf, TokenStorage tokenStorage) throws IOException{
    ...
    if(tokensFileName != null) {
      ...
      try {
        ...
        for(Map.Entry<String, String> ent: nm.entrySet()) {
          TokenCache.addSecretKey(tokenStorage, new Text(ent.getKey()), ent.getValue().getBytes());
        }
    ...
    if(nameNodes != null) {
      ...
      TokenCache.obtainTokensForNamenodes(tokenStorage, ps, conf);
    }
  }
}
