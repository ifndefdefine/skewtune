...
public class Job extends JobContextImpl implements JobContext {  
  ...
  public void submit() throws IOException, InterruptedException, 
    ...
    status = new JobSubmitter(cluster.getFileSystem(),
      cluster.getClient()).submitJobInternal(this, cluster, getTokenStorage());
    state = JobState.RUNNING;
   }
  ...
  public void setTokenStorage(TokenStorage storage) {
      ensureState(JobState.DEFINE);
      tokenStorage = storage;
  }
  
  public TokenStorage getTokenStorage() {
      return ( tokenStorage == null ) ? TokenCache.getTokenStorage() : tokenStorage;
  }
}
