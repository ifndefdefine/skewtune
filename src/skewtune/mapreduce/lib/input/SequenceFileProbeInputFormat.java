 ...
 * format.
 */
public class SequenceFileProbeInputFormat
    extends SequenceFileInputFormat<LongWritable,RecordLength> {

  public SequenceFileProbeInputFormat() {
    super();
  }

  public RecordReader<LongWritable,RecordLength> createRecordReader(
      InputSplit split, TaskAttemptContext context)
      throws IOException {
    return new SequenceFileProbeRecordReader();
  }
  
  /**
   * Read records from a SequenceFile as (offset, length) pairs
   */
  public static class SequenceFileProbeRecordReader
      extends RecordReader<LongWritable,RecordLength> {
    ...
    private RecordLength value = new RecordLength();
    ...
    @Override
    public RecordLength getCurrentValue() 
        throws IOException, InterruptedException {
      return value;
    }
    ...
    public synchronized boolean nextKeyValue()
      ...
      if (!eof) {
        ...
        value.set(buffer.getLength(), vbytes.getSize(), (int)(in.getPosition() - pos), in.syncSeen());
      }
      buffer.reset();
